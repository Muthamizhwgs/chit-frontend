...
import ChitMapping from "./components/admin/chitmapping2.0";
...
import Pamentdetails from "./components/admin/pamentdetails";
    ...
    <>
      <Routes>
        ...
        <Route path="/homepage" element={<Homepage />}>
          ...
          <Route
            path="/homepage/chitmapping/chitmapdetails"
            element={<ChitMapDetails />}
          />
          <Route path="/homepage/manageauction" element={<Auction />} />
          <Route
            path="/homepage/manageauction/auctiondetails"
          ...
          <Route
            path="/homepage/reports/reportDetails"
            element={<ReportTable />}
          />
          ...
          <Route
            path="/homepage/auction/UserauctionDetails"
            element={<AuctionDetails />}
          />
        </Route>
      </Routes>
