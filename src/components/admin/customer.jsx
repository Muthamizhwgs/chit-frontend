...
function Customers() {
  ...
  const columns = [
    ...
    {
      name: <h1 className="text-lg text-gray-500">Phone No</h1>,
  ...
  return (
    <>
      ...
      <div>
        <Modal
          title={edit ? "Edit Customer" : "Add Customers"}
          height={"260px"}
          open={isModalOpen}
        ...
        >
          <div className="flex flex-col justify-center">
            ...
            <div className="flex flex-col mb-4">
              ...
              {/* {edit ? (
                <Select
                  ...
                  options={
                    referenceUser &&
                    referenceUser.map((e) => ({ value: e.id, label: e.name }))
                  }
                />
              ) : ( */}
              <Select
            ...
            {forms.errors.reference && forms.touched.reference ? (
              <div style={{ width: "100%", color: "red", paddingLeft: "15px" }}>
                {forms.errors.reference}
              </div>
            ) : null}
            {err ? (
              <div style={{ width: "100%", color: "red", paddingLeft: "15px" }}>
